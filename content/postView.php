...
<head>
    ...
    @font-face {
        font-family: Nexa;
        src: url('images/bemui/nexa/nexa.otf') format('opentype');
    }
    /* Plugin CSS*/
        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="logo">
                                <img class="img-scroll" src="img/logo-bem.png">
                        </div>
                    </div>
                    <div class="col-sm-9">
                            ...
                            <div class="navbar">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smoth-scroll" href="profil.html">Profil</a>
                                        </li>
                                        <li><a class="smoth-scroll" href="Informasi.html">Informasi</a>
                                        </li>
                                        <li><a class="smoth-scroll" href="bem aps.html">BEM APS</a>
                                        </li>
										<li><a class="smoth-scroll" href="contact new.html">Kontak</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
